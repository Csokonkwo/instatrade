        ...
        <div class="form">
           <div class="container">
                ...
                <form action="signup.php" method="POST" onSubmit="return validateReg(this)">
                    ...
                    <p class=""> <br>
                        Once you've filled in your details, you'll be ready to start investing. <br> <br>
                    </p>
                    ...
                    <div class="checkbox">
                        ...
                        <label for="checkbox">  I have read and agree to the <a style="color:blue" href="<?php echo BASE_URL.'/about/terms.php'?>">Terms & Conditions</a> which provides that <?php echo $companyEmail ?> is an online service and that you will receive all account notices and information electronically via your primary email address. You have also read and agree to the <a style="color:blue" href="<?php echo BASE_URL.'/about/privacy.php'?>">Company's Privacy Policy.</a>  If you provide your mobile number, you confirm that you are authorized to add this number and give us permission to contact you about your branded accounts using automated calls or texts to service your accounts, investigate fraud.</label><br>
                    </div>

                    <p class=""> <br>
                        Already got an account? <a href="signin.php">Sign in</a>
                    </p>
